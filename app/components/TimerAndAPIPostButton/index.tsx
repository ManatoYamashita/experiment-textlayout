...
export default function TimerAndAPIPostButton({ currentText, currentMargin }: ButtonsProps) {
  ...
  const texts = useMemo(
    () => [
      // `
      // 『ある研究』
      // 「ねえ。あなた」 と、妻が呼びかけた。その男はふきげんそうに顔をあげ、ふりむきながら応じた。「なんだ。いまは忙しいんだ」「その、わけのわからない研究とやらは、いったい、いつになったら片がつくの」「わからん。すぐのような気もするが、あるいは、意外に手間どるかもしれない」「あたしと研究と、どっちが大切なの」「さあ……。まあ、どうでもいいじゃないか、そんなことは」「よくないわよ」「おれはこの研究に、なぜだかわからないが、心をひかれている。なにか、すばらしい結果がもたらされそうに思えてならないのだ」「そんな、いいかげんな研究より、あたしのほうが大切なのは、わかりきったことじゃないかしら」 彼女の語調は、しだいに強まってきた。彼は当惑したような、あいまいな声を出した。「ああ……」「変なことに熱中するのは、いいかげんでやめて、まともに働いてよ。あたし、新しい毛皮が欲しいの」「そのうち手に入れてやる。待ってくれ」「もう待てないわ。いまのままをつづけたいのなら、あたしが出て行くわよ」「わかったよ」 彼は適当にごまかそうとしたが、妻の追及はゆるまなかった。「どうわかったの」「みなに手伝ってくれるよう、たのんでみる。みなの助けが得られそうになければ、今度こそ、きっぱりあきらめる。本当だ」「じゃあ、これからすぐに、出かけてよ。これ以上、どっちつかずの気持ちで毎日をすごすのは、ごめんだわ」 男は追い立てられるように外出した。 「……というわけです。どうでしょう。あなたから、みなに命じていただけませんか」 と、男は言った。権力者である老人は、うなずきながら、その話に耳を傾けていた。しかし、やがて、気の毒そうに首をふった。「きみの熱心さはわかる。しかし、みなをなっとくさせることは、わしにも無理だろうな。もっとも、それがどんな役に立つのかを、はっきり説明できれば、なんとかなるかもしれないが。……どうなのだ、この点は」「出来てみなければ、なんとも言えませんが、きっと驚くほど役に立つでしょう。わたしが想像しているよりも、はるかに……」「そんなあいまいな話では、どうにもならん。それに危険なことは、わしにさえわかる。また、みなはきみのやっていることを悪魔のように恐れ、なかには、きみに近づかれるのをいやがるものすらある。だから、みなに命ずる気になれないのだ。へたをすると、わしまで、いまの地位を失いかねない」「どうしてもだめでしょうか。戦争に費す労力の、ほんの一部分程度でいいのです。少しでも早く完成するのが、すべての人のためだと、わたしは心から信じているのですが……」「だめだ。わしは、きみのために忠告するよ。このへんで思いとどまって、家族を安心させてあげなさい」「そうでしょうか……」 と、男は未練を残した。どうにも、あきらめなければならない情勢だった。彼は老人と別れ、力なく、妻のところへと戻った。「どうだったの」 と、彼女は迎えた。男はゆううつそうに、「だめだそうだ」「だれだって、そう答えるわよ。さあ、あの変な物をみんな捨てて、それから、毛皮を手に入れてきてちょうだい。まもなく冬よ。あたし、寒いのはきらいなの」「しかし、寒さなど……」 男はこう言いかけたものの、もはや、すべてを断念していた。彼はいろいろな研究用の資料を抱えあげ、ふたたび外へ出た。 各種の太さの木の棒、くぼみのある板。板のくぼみのまわりは、かすかだが黒くこげている。彼はそれを、残念そうに手でなでた。 もうちょっとなのだろうが、いつも途中でくたびれ、棒を板にこすりつづける作業を、中断しなくてはならなくなる。だれかに手伝ってもらい、交代でやりさえすれば、板の熱はもっと高まり、ついには、火となってくれそうな気がしてならないのだった。「火を作れるのは、神か悪魔だけに許された仕事なのかもしれない。あるいは、作ってみたところで、なんの役にも立たないかもしれない。また、たしかに危険なことでもある。だけど、本当に作れたとしたら、どんなにかすばらしいことだろうな……」 男はつぶやきながら、そばの川に投げこんだ。棒や板は、水に乗って流れ去っていった。人類が火を所有するには、かくして、また何万年かの時間を待たなければならなかった。
      // `,
      ...
      // `
      // 『追い越し』
      // 明かるい日の光を受け、ハイウェイはずっと伸びていた。その男の運転する最新型の自動車は、郊外にむかって滑るように進んでいた。新しい車は、なにもかも調子がよかった。彼はこれから、新しくつきあいはじめた女の家を訪ねにゆくところだった。「自動車は新しい型のに限る。いや、自動車ばかりではない。女の子も同じことだ。古い型のはなんでも、つぎつぎと払い下げ、新しい型のを手に入れる。これがおれの主義なんだ」 彼はこうつぶやきながらスピードをあげた。いくらかあけた窓からは風が流れこみ、彼のいかにもドンファンらしく見える顔にあたった。 軽く快くつづく振動は、彼に少し前に売り払った古い型の車のことを思い出させた。そして、それとともに、このあいだ別れた女のことに連想が移った。「あなたは、あたしがきらいになったのでしょうね、そうなんでしょう」 彼が別れ話をきりだした時、そのモデルを仕事としているという女は、顔をひきつらせ、すがるような声で言ったのだった。「いや、そういうわけでは……」 彼はあいまいに答えたが、女はますます真剣になった。「ねえ、別れるのはいやよ。あたしを捨てないで」「しかし、これ以上つきあうのは、おたがいのためにも、意味ないと思うんだが」「あなたと会えなくなるのなら、あたし、死んでしまうつもりよ」 よくあるせりふだ。女はいつも別れ話の時には、こんな言葉を使う。だが、この手が通用するのなら、世の中で女と手が切れる者など、ないはずだ。彼はこう簡単に片づけ、べつの女に熱中しはじめたのだった。 しかし、まさか本当に死んでしまうとはな……。 しばらくして、彼女が自殺したのだ。彼はこのことを思い出すたびに、いやな気持ちになった。もちろん、別れた女に死なれては、だれでもいい気持ちではない。しかし、彼の場合には、それをさらに重苦しくさせることが加わっていた。それは、別れぎわに彼女が言い足した言葉だった。「あたしは死んでからも、あなたにどこかで会うつもりよ。きっと会うわ。その時には、せめて手でも握ってね」 いったい、どういうつもりで、あんなことを言ったのだろう。彼はこの言葉が忘れられず、思い出すたびに不気味な感じにおそわれた。「どうせ、いやがらせさ。その場の思いつきで、なんの気なしに口から出たんだ。気にすることはない」 彼はつぶやきながら、この気持ちをふりきるように、さらにスピードをあげた。そして、前を走っている一台の車に迫った。 しかし、彼は追い越すのを不意にやめた。前の車の後部座席に乗っている女のうしろ姿が、あの女に似ているように思えたのだ。彼はしばらく見つめていたが、やがて強く首を振った。 気のせいだ。気のせいだとも。きょうのおれは、どうかしている。彼女は、たしかに死んだのだ。いま、こんなことを考えていたから、ふと見た女が似ているように思えただけだ。こんな気分は、追い払わなければ。追い払うのは簡単さ。追い越しながら、顔をたしかめればいいのだ。 彼はふたたびスピードをあげ、追い越しながら、その女の顔に目を走らせた。「あっ」 彼は悲鳴をあげた。それは疑いもなく、あの女ではないか。しかも、彼にむけて、手をさしのべている。「握ってよ」 と呼びかけるように。彼は、思わず両手で顔をおおった。「即死ですね。しかし、いったい、なんでこんな事故になったのでしょう。目撃なさっていて、なにか気がついたことはありませんか」 警官は手帳に書き込みながら、追い越されたほうの車を運転していた男に聞いた。「まったく、わかりません。わたしの車を追い越して、しばらくいってから、電柱めがけてつき当ったんです。急に目まいでもしたとしか、考えられませんね」「そうですか」 警官は手帳を閉じながら、なにげなく、その男の車のなかをのぞいて言った。「ところで、うしろの席の女のかたは、なにかようすがおかしいようですが……」「いや、あれはマネキン人形ですよ。わたしは、マネキン人形のメーカーをやっているのです。これから注文先に届ける途中なんです」「なかなか、うまく出来ているものですな」「ええ、これを作る時の、モデルがよかったのです。いいモデルでしたよ。しかし、気の毒なことに、男に振られて、しばらく前に自殺してしまいましてね」
      // `,
